...
from .views import (BookViewSet, FlashCardViewSet,
                    UserProfileViewSet, DictionaryEntryViewSet,
                    AuthViewSet, TranslateView, 
                    TranslationHistoryListView, TranslationDetailView,
                    ConversationViewSet)
